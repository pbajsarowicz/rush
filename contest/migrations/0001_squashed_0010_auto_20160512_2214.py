    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lowest_year', models.SmallIntegerField(verbose_name='Wiek minimalny')),
                ('highest_year', models.SmallIntegerField(verbose_name='Wiek maksymalny')),
                ('deadline', models.DateTimeField(verbose_name='Termin zg\u0142aszania zawodnik\xf3w')),
